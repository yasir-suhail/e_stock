...
import 'package:e_stock/views/widget/empty_logs.dart';
...
class _LogsScreenState extends State<LogsScreen> {
  ...
  // contain  the data currenty displaty
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            Expanded(
              child:displayLogs.isEmpty?EmptyLogs(filter: selectedLogType)
              // child: filterLogs.isEmpty
              //     ? Center(
              //         child: Text(
              //           'NO ${selectFilter} inventory found',
              //           style: TextStyle(
              //             fontSize: 16,
