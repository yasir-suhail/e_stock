...
class _AddSalesmanScreenState extends State<AddSalesmanScreen> {
  ...
  var addSalesmanPhoneController = TextEditingController();
                      ...
                      Form(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextfield(
                              focusedColor: AppColors.vanAmber,
                              controller: addSalesmanPhoneController,
                              keyboardtype: .phone,
                            ...
                            CustomButton(
                              ...
                              onTap: () async {
                                ...
                                final (success) = await context
                                    .read<AuthViewModel>()
                                    .createSalesman(
                                  name: addSalesmanNameController.text
                                      .trim(),
                                  email: addSalesmanEmailController.text
                                      .trim(),
                                  password: addSalesmanPasswordController
                                      .text
                                      .trim(),
                                  phone: addSalesmanPhoneController.text
                                      .trim(),
                                );
                                if (!mounted) return;
                                if (success) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                      ...
                                      //clear field
                                      addSalesmanNameController.clear();
                                      addSalesmanEmailController.clear();
                                  addSalesmanPasswordController.clear();
                                  addSalesmanPhoneController.clear();
                                } else {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
